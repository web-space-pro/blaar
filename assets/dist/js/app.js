...
try {
  ...
  __webpack_require__(/*! ./modules/input_mask */ "./assets/src/js/modules/input_mask.js");
...
/***/ "./assets/src/js/modules/input_mask.js":
/*!*********************************************!*\
  !*** ./assets/src/js/modules/input_mask.js ***!
  \*********************************************/
/***/ (() => {
...
jQuery(function ($) {
  var inputNames = ['billing_phone', 'shipping_phone', 'user_phone', 'targetvr_billing_phone'];
  ;
  if ($.fn.mask) {
  ...
  */
  function updateVariationImage(variation, productWrapper) {
    ...
    if (variation && variation.vargal_params && variation.vargal_params.length > 0) {
      ...
      var firstVariationImage = variation.vargal_params[0];
      productImageWrapper.attr('src', firstVariationImage);
      productImageWrapper.attr('srcset', firstVariationImage);
    } else {
      setTimeout(function () {
        var imgOrig = productWrapper.find('.woocommerce-LoopProduct-link > img');
