...
try {
  ...
  __webpack_require__(/*! ./vendors */ "./assets/src/js/vendors.js");
  // require("./modules/input_mask");
  __webpack_require__(/*! ./modules/menu */ "./assets/src/js/modules/menu.js");
  __webpack_require__(/*! ./modules/slider */ "./assets/src/js/modules/slider.js");
  __webpack_require__(/*! ./modules/rellax */ "./assets/src/js/modules/rellax.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var wheelOuter = document.querySelector(".wheelspin__outer");
  var formContainer = document.querySelector(".formContainer");
  var currentRotation = 0;
  var spunKey = "wheelspin_spun"; // Ключ для хранения времени кручения колеса
  var spinFormId = "7556"; // ID формы CF7

  var prizes = [{
    name: "2 бесплатных урока",
    chance: 40,
    angle: 0
  }, {
    name: "Полное бесплатное обучение",
    chance: 0,
    angle: 60
  }, {
    name: "5 уроков бесплатно",
    chance: 0,
    angle: 120
  }, {
    name: "Месяц разговорных клубов",
    chance: 5,
    angle: 180
  }, {
    name: "Экспресс оценка уровня",
    chance: 15,
    angle: 240
  }, {
    name: "1 бесплатный урок",
    chance: 40,
    angle: 300
  }];
  function getRandomPrize() {
  ...
  function spinWheel() {
    ...
    var selectedPrize = getRandomPrize();
    var stopAngle = selectedPrize.angle;
    var spins = Math.floor(Math.random() * 3) + 5;
    var finalAngle = spins * 360 + stopAngle;
    currentRotation += finalAngle;
    var spinKeyframes = "\n            @keyframes spinAnimation {\n                0% { transform: rotate(".concat(currentRotation - finalAngle, "deg); }\n                100% { transform: rotate(").concat(currentRotation, "deg); }\n            }\n        ");
    var styleTag = document.getElementById("spinAnimationStyle");
    if (styleTag) {
      styleTag.innerHTML = spinKeyframes;
    } else {
      styleTag = document.createElement("style");
    ...
    wheelOuter.addEventListener("animationend", function () {
      ...
      // Удаляем форму
      var formContainer = document.querySelector(".present-form");
      if (formContainer) {
        formContainer.remove();
      }

      // Показываем выигрыш
      var winContainer = document.querySelector(".present-win");
      if (winContainer) {
  ...
  function sendToBitrix() {
    var contactUrl = "https://profieng.bitrix24.ru/rest/1/ho8z3mhsne8b93c1/crm.contact.add.json";
    var dealUrl = "https://profieng.bitrix24.ru/rest/1/ho8z3mhsne8b93c1/crm.deal.add.json";
    var proAdvData = sessionStorage.getItem("proAdvData");
    var prizeTextElement = document.getElementById("prizeText");
    var prize = prizeTextElement.textContent.trim();
    if (proAdvData) {
      proAdvData = JSON.parse(proAdvData);
    }
    var contactData = {
      fields: {
        NAME: "Клиент",
        PHONE: [{
          VALUE: proAdvData.phone,
          VALUE_TYPE: "WORK"
        }],
        COMMENTS: "\u0412\u044B\u0438\u0433\u0440\u044B\u0448: ".concat(prize)
      }
    };
    fetch(contactUrl, {
      method: "POST",
      ...
      if (result.result) {
        var dealData = {
          fields: {
            TITLE: "\u0412\u044B\u0438\u0433\u0440\u044B\u0448: ".concat(prize),
            COMMENTS: "\u041D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430: ".concat(proAdvData.phone),
            STATUS_ID: "NEW",
            CONTACT_ID: result.result
          }
        };
      ...
      return console.log("Сделка добавлена в Битрикс:", result);
    })["catch"](function (error) {
      return console.error("Ошибка при отправке данных в Битрикс:", error);
    });
  }
  function sendAdvCakeData() {
    window.advcake_data = window.advcake_data || [];
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var subMenuWrap = document.querySelector(".sub-menu");
  var timeoutId;
  menuItems.forEach(function (item) {
    var menuId = item.id.replace("menu-item-", "");
    var submenu = document.querySelector('.custom-submenu[data-menu-id="' + menuId + '"]');
    if (!submenu) return; // Если нет подменю, ничего не делаем

    item.addEventListener("mouseenter", function () {
      clearTimeout(timeoutId); // Отменяем скрытие
      document.querySelectorAll(".custom-submenu").forEach(function (sub) {
        return sub.classList.remove("toggled");
      });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  titles.forEach(function (title) {
    title.addEventListener("click", function () {
      ...
      document.querySelector(".menu-content[data-menu-id=\"".concat(menuId, "\"]")).classList.remove("hidden");
...
/***/ "./assets/src/js/modules/rellax.js":
/*!*****************************************!*\
  !*** ./assets/src/js/modules/rellax.js ***!
  \*****************************************/
...
function initRellax() {
  if (window.innerWidth > 992) {
    rellaxInstance = new (rellax__WEBPACK_IMPORTED_MODULE_0___default())('.rellax', {
      speed: -3,
      center: false,
      wrapper: null,
      round: true,
...
__webpack_require__(/*! ./woocommerce/single-product */ "./assets/src/js/modules/woocommerce/single-product.js");
__webpack_require__(/*! ./woocommerce/cart */ "./assets/src/js/modules/woocommerce/cart.js");

/***/ }),

/***/ "./assets/src/js/modules/woocommerce/cart.js":
/*!***************************************************!*\
  !*** ./assets/src/js/modules/woocommerce/cart.js ***!
  \***************************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.body.addEventListener("click", function (event) {
    var button = event.target.closest(".qty-minus, .qty-plus");
    if (!button) return;
    ...
    updateTimeout = setTimeout(function () {
      return updateCart(input, newValue, abortController.signal);
    }, 300);
  });

  // Обработчик для кнопок удаления товара
  document.body.addEventListener("click", function (event) {
    var removeButton = event.target.closest(".product-remove a"); // Находим кнопку удаления
    if (!removeButton) return;
    event.preventDefault(); // Предотвращаем переход по ссылке

    // Получаем строку товара
    var cartItemRow = removeButton.closest(".cart_item");
    if (!cartItemRow) return;

    // Получаем ID товара из data-атрибута
    var itemId = removeButton.getAttribute("data-product_id");
    if (!itemId) return;
    console.log(itemId);

    //Устанавливаем новое количество (если товар удаляется, количество будет 0)
    var quantityInput = cartItemRow.querySelector(".qty");
  ...
  function updateCart(_x, _x2, _x3) {
    return _updateCart.apply(this, arguments);
  }
  function _updateCart() {
    _updateCart = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(input, quantity, signal) {
      var inputName, match, itemHash, response, data, cartTable, checkoutReviewTable, cartCollaterals, orderTotalElement;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            inputName = input.getAttribute("name");
            match = inputName.match(/cart\[([a-f0-9]+)\]\[qty\]/);
            if (!(!match || !match[1])) {
              _context.next = 5;
              break;
            }
          ...
          case 12:
            ...
            if (data.success) {
              if (data.data.cart_count != 0) {
                cartTable = document.querySelector(".shop_table.cart");
                if (cartTable) {
                  cartTable.innerHTML = new DOMParser().parseFromString(data.data.cart_html, "text/html").querySelector(".shop_table.cart").innerHTML;
                }
              }
              checkoutReviewTable = document.querySelector(".woocommerce-checkout-review-order-table");
              if (checkoutReviewTable) {
                checkoutReviewTable.innerHTML = new DOMParser().parseFromString(data.data.checkout_review_html, "text/html").querySelector(".woocommerce-checkout-review-order-table").innerHTML;
              }

              // Обновляем сумму заказов в корзине
              cartCollaterals = document.querySelector(".cart_totals");
              if (cartCollaterals) {
                cartCollaterals.innerHTML = new DOMParser().parseFromString(data.data.cart_collaterals_html, "text/html").querySelector(".cart_totals").innerHTML;
              }

              // Обновляем итоговую сумму заказа
              orderTotalElement = document.querySelector("#order-total-cart");
  ...
  function updateCartCount(count) {
    var cartCountElement = document.getElementById("cart-total");
    if (cartCountElement) {
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll(".form-row input").forEach(function (input) {
    var formRow = input.closest(".form-row");
    var label = formRow ? formRow.querySelector("label") : null;
    if (label) {
...
jQuery(document).ready(function ($) {
  ...
  var button = $('#show-filters');
  var closeButton = $('#close-filters');
  ...
  $(document).on('click', function (event) {
    if (!filters.is(event.target) && filters.has(event.target).length === 0 && !button.is(event.target) && button.has(event.target).length === 0) {
      filters.fadeOut(300);
      $('body').removeClass('ov-hidden');
    }
  });
...
/***/ "./assets/src/js/modules/woocommerce/single-product.js":
/*!*************************************************************!*\
  !*** ./assets/src/js/modules/woocommerce/single-product.js ***!
  \*************************************************************/
/***/ (() => {
...
jQuery(document).ready(function ($) {
  $('form.variations_form').on('change', 'select, .swatch-wrapper', function () {
    setTimeout(function () {
      var variationId = $('input.variation_id').val(); // ID выбранной вариации

      if (variationId && variationImages[variationId]) {
        $('#main-product-image').attr('src', variationImages[variationId].image);
        var galleryContainer = $('#product-gallery-thumbs');
...
/***/ "./assets/src/js/plugins/jquery.maskedinput.min.js":
/*!*********************************************************!*\
  !*** ./assets/src/js/plugins/jquery.maskedinput.min.js ***!
  \*********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _plugins_jquery_maskedinput_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./plugins/jquery.maskedinput.min */ "./assets/src/js/plugins/jquery.maskedinput.min.js");
...
/* harmony import */ var slick_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! slick-animation */ "./node_modules/slick-animation/slick-animation.js");
/* harmony import */ var slick_animation__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(slick_animation__WEBPACK_IMPORTED_MODULE_1__);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksimbiotica"] = self["webpackChunksimbiotica"] || [];
